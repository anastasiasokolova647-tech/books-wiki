                ...
                document.addEventListener(
                  ...
                  async (event) => {
                    ...
                    if (installPrompt) {
                      ...
                      alert(
                        "РЇРєС‰Рѕ РІС–РєРЅРѕ РІСЃС‚Р°РЅРѕРІР»РµРЅРЅСЏ РЅРµ Р·вЂ™СЏРІРёР»РѕСЃСЏ, РІС–РґРєСЂРёР№ РјРµРЅСЋ Р±СЂР°СѓР·РµСЂР° С‚Р° РѕР±РµСЂРё В«Р’СЃС‚Р°РЅРѕРІРёС‚Рё РґРѕРґР°С‚РѕРєВ»."
                      );
                    }
                  }
                );
